 ...
 * @property {string|null}          sortProp         Property of ResultRowData that is the current sort column
 * @property {number}               sortDirection    asc = 1, desc = -1
 */
 ...
 * @property {GetStateCB}  getState   Returns a copy of the current state
 * @property {DispatchCB}  dispatch   Dispatch an action, all state mutations go through here
 * @param {Action}         action
 *
 * @callback GetStateCB
 * @returns {AppState}
